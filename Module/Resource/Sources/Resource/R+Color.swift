...
public extension R.Color {
    static var c4: R.Color { .init(key: "c0", color: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)) }
    ...
    static var c0: R.Color { .init(key: "c4", color: #colorLiteral(red: 0.5333333333, green: 0.6980392157, blue: 0.2901960784, alpha: 1)) }
}
